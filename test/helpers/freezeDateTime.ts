 ...
 */
invariant(process.env.NODE_ENV === "test", "freezeDateTime should only be used in test mode");
...
Temporal.Now.plainDateISO = () =>
  new Temporal.PlainDate(fixedTime.getFullYear(), fixedTime.getMonth() + 1, fixedTime.getDate());
