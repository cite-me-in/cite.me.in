      ...
      <Row>
        <Column style={{ verticalAlign: "middle" }}>
          <Row>
            ...
            <Column style={{ verticalAlign: "middle" }}>
              <Link href={new URL(`/site/${domain}`, envVars.VITE_APP_URL).toString()}>
                <Text className="text-dark m-0 line-clamp-1 text-2xl leading-tight font-bold">
                  {domain}
                </Text>
                <Text className="mt-4px text-light m-0 line-clamp-1 text-sm">{subject}</Text>
              </Link>
            </Column>
          </Row>
        </Column>
        <Column className="text-right" style={{ verticalAlign: "middle", whiteSpace: "nowrap" }}>
...
function Footer({ unsubscribeURL }: { unsubscribeURL?: string | false }) {
  return (
    <Section className="mt-8 border-t border-gray-200 pt-6">
      ...
      <Text className="text-light my-2 text-center text-xs">Squirrel-brain friendly 🐿️</Text>
    </Section>
  );
}
