    ...
    <script type="application/ld+json">
      {JSON.stringify({
        ...
        "@graph": [
          ...
          AI chatbots questions in your market. Tools like ChatGPT, Perplexity, and Claude increasingly answer questions directly — AEO monitoring
           tells you if you're showing up in those answers.`,
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: `cite.me.in runs AI queries on your behalf across ChatGPT, Perplexity, and Claude, then checks whether your brand
          ...
          Perplexity, and Claude.`,
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: `AEO monitoring tools range from $29 to $400+/month. cite.me.in offers a 25-day free trial with no credit card, then
          $${prices.monthlyAmount}/month for the Pro plan. It's also open-source and self-hostable for free if you prefer to run your own instance.`,
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: `Yes. cite.me.in is fully open-source. You can self-host it for free with no limits. The hosted service at cite.me.in
          costs $${prices.monthlyAmount}/month and handles setup, maintenance, and weekly email reports for you.`,
                },
              },
            ],
          },
