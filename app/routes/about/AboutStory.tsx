    ...
    <section className="mx-auto max-w-4xl bg-[hsl(60,100%,99%)] py-20">
      <div className="flex flex-col gap-8">
        <div className="flex items-start gap-4">
          <div className="rounded-base flex h-12 w-12 shrink-0 items-center justify-center border-2 border-black bg-[#F59E0B] text-black shadow-[2px_2px_0px_0px_black]">
