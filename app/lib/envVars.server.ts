...
const envVars = {
  ANTHROPIC_API_KEY: env.get("ANTHROPIC_API_KEY").required(!isTest).asString(),
  ...
  STRIPE_SECRET_KEY: env.get("STRIPE_SECRET_KEY").required(!isTest).asString(),
  STRIPE_WEBHOOK_SECRET: env.get("STRIPE_WEBHOOK_SECRET").required(false).asString(),
  TRACK_API_KEY: env.get("TRACK_API_KEY").required(!isTest).asString(),
  ...
  ZHIPU_API_KEY: env.get("ZHIPU_API_KEY").required(!isTest).asString(),
};
